...
class alerter:
    ...
    def get_ph(self, location):
        ...
        data = [['Manipal Police Station', +919820218571], ['Chennai Central RPF', +919619616979], ['Kasba Peth Police Chowki', +918420856104]]
    ...
    def send_fire_msg(self, location, threat_level, threat_class):
        ...
        data = [['Manipal', +919619616979], ['Chennai', +918420856104], ['Pune', +919820218571]]
